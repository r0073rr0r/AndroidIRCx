...
export const SETTINGS_ICONS: Record<string, SettingIcon> = {
  ...
  'layout-userlist-size': { name: 'arrows-alt-h', solid: false },
  'layout-userlist-nick-font-size': { name: 'text-width', solid: false },
  'layout-userlist-reset-defaults': { name: 'undo', solid: false },
  'layout-nicklist-tongue-enabled': { name: 'grip-lines', solid: false },
  'layout-nicklist-tongue-size': { name: 'ruler-horizontal', solid: false },
